...
import SalesComponent from "../contact/sales";
...
test("percentage is working", () => {
  render(
    <SalesComponent
      lastUploadDate={salesOverviewNormal.lastUploadDate}
...
test("percentage is bigger than 100%", () => {
  render(
    <SalesComponent
      lastUploadDate={salesOverviewBiggerHundredPerCent.lastUploadDate}
